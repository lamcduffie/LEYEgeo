...
setwd = ("T:/McDuffie/LEYE_GEO/LEYE_591")

list.files(path = "T:/McDuffie/LEYE_GEO/LEYE_591", pattern = NULL, all.files = FALSE,
           full.names = FALSE, recursive = FALSE,
           ignore.case = FALSE, include.dirs = FALSE, no.. = FALSE)

#For Intigeo geos: read the data into a dataframe called d.lux
d.lux <- readMTlux("T:/McDuffie/LEYE_GEO/LEYE_591/Z591_15Jun17_014524.lux") 
